;======================================================================
; 3-STACK NANOSHEET NMOS GAAFET WITH HfO2 BDI ISOLATION (Tbdi = 51.3 nm)
; Sentaurus Structure Editor (SDE) - NEW EXPERIMENTAL COPY
; Output mesh file: GAA_3NS_NMOS_hfo2_msh.tdr
;
...
;   BDI thickness Tbdi = 51.3 nm (HfO2 Bottom Dielectric Isolation)
...
(define Tbdi 0.0513) (define Tsub 0.020) ; <--- Tbdi adjusted to 51.3 nm for HfO2 (equal capacitance)
...
;--- 2. Bottom Dielectric Isolation (BDI / HfO2 - 51.3 nm) ---------
(sdegeo:create-cuboid (position xS0 yg0 zBDI_bot) (position xD1 yg1 zg0) "HfO2" "R.BDI") ; <--- Material changed to HfO2
...
;--- Mesh Refinement (optimized for speed: coarse passive regions) ----
; FAST variant: coarser cells in S/D, BDI and substrate; channel/gate
; stack resolution preserved so device currents differ negligibly.
