...
File {
    Grid    = "GAA_3NS_NMOS_hfo2_msh.tdr"
    Plot    = "GAA_3NS_NMOS_hfo2_des.tdr"
    Current = "GAA_3NS_NMOS_hfo2_des.plt"
    Output  = "GAA_3NS_NMOS_hfo2_des.log"
}
...
Solve {
    ...
    NewCurrentPrefix = "IdVg_Vd005_hfo2_"
    ...
    NewCurrentPrefix = "IdVg_Vd070_hfo2_"
    ...
    NewCurrentPrefix = "IdVd_Vg000_hfo2_"
    Quasistationary (
        Iterations  = 50
        InitialStep = 0.01   Increment = 1.3   Decrement = 2.0
        MinStep     = 1e-9   MaxStep   = 0.025
    ...
    NewCurrentPrefix = "IdVd_Vg020_hfo2_"
    Quasistationary (
        Iterations  = 50
        InitialStep = 0.01   Increment = 1.3   Decrement = 2.0
        MinStep     = 1e-9   MaxStep   = 0.025
    ...
    NewCurrentPrefix = "IdVd_Vg040_hfo2_"
    Quasistationary (
        Iterations  = 50
        InitialStep = 0.01   Increment = 1.3   Decrement = 2.0
        MinStep     = 1e-9   MaxStep   = 0.025
    ...
    NewCurrentPrefix = "IdVd_Vg060_hfo2_"
    Quasistationary (
        Iterations  = 50
        InitialStep = 0.01   Increment = 1.3   Decrement = 2.0
        MinStep     = 1e-9   MaxStep   = 0.025
    ...
    NewCurrentPrefix = "IdVd_Vg070_hfo2_"
    Quasistationary (
        Iterations  = 50
        InitialStep = 0.01   Increment = 1.3   Decrement = 2.0
        MinStep     = 1e-9   MaxStep   = 0.025
