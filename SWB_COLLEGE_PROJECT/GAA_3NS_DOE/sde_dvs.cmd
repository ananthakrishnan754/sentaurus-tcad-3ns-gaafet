;======================================================================
; Sentaurus Structure Editor (SDE) for Sentaurus Workbench (SWB)
; 3-Stack NMOS GAAFET with Dynamic Region-Adaptive Meshing
; Parameters from SWB: @Lg@, @Wns@, @Tns@ (values in nm)
;======================================================================

(sde:clear)
(sdegeo:set-default-boolean "ABA")

;--- Geometric Dimensions (convert nm to micrometers) ---
(define Lg   (/ @Lg@ 1000.0))
(define Wns  (/ @Wns@ 1000.0))
(define Tns  (/ @Tns@ 1000.0))
(define Ls   0.0150)
(define Ld   0.0150)
(define Tgap 0.0080)
(define Tox  0.0010)
...
;--- Y Coordinates (centered width) ---
(define y0 (- (/ Wns 2.0)))
(define y1 (/ Wns 2.0))

;--- Z Coordinates (3 stacked nanosheets) ---
(define z1b 0.0000)             (define z1t (+ z1b Tns))
...
; 2. Coarsened Substrate & BDI Base
...
; 3. Active Channel Inversion Layer
