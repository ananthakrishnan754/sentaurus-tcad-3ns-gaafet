...
Placements {
	...
	Refinement "RefPlace.Global" {
		...
		RefineWindow = Cuboid [(-0.015 -0.0115 -0.034) (0.025 0.0115 0.032)]
	}
	Refinement "RefPlace.SubBDI" {
		Reference = "RefDef.SubBDI"
		RefineWindow = Cuboid [(-0.015 -0.0115 -0.034) (0.025 0.0115 -0.004)]
	}
	Refinement "RefPlace.Chan" {
		Reference = "RefDef.Chan"
		RefineWindow = Cuboid [(-0.001 -0.009 -0.0015) (0.011 0.009 0.0295)]
	}
}
