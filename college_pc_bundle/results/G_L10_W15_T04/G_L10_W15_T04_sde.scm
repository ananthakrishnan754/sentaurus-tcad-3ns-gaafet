; Run: G_L10_W15_T04 (Lg=10nm, Wns=15.0nm, Tns=4.0nm, N=3)
(sde:clear)
(sdegeo:set-default-boolean "ABA")

;--- Substrate & BDI Base ---
(sdegeo:create-cuboid (position -0.0150 -0.0115 -0.0340) (position 0.0250 0.0115 -0.0140) "Silicon" "R.Substrate")
(sdegeo:create-cuboid (position -0.0150 -0.0115 -0.0140) (position 0.0250 0.0115 -0.0040) "SiO2" "R.BDI")

;--- Nanosheet Layer 1 ---
(sdegeo:create-cuboid (position -0.0150 -0.0075 0.0000) (position 0.0000 0.0075 0.0040) "Silicon" "R.Source1")
(sdegeo:create-cuboid (position 0.0000 -0.0075 0.0000) (position 0.0100 0.0075 0.0040) "Silicon" "R.Channel1")
(sdegeo:create-cuboid (position 0.0100 -0.0075 0.0000) (position 0.0250 0.0075 0.0040) "Silicon" "R.Drain1")
;--- Nanosheet Layer 2 ---
(sdegeo:create-cuboid (position -0.0150 -0.0075 0.0120) (position 0.0000 0.0075 0.0160) "Silicon" "R.Source2")
(sdegeo:create-cuboid (position 0.0000 -0.0075 0.0120) (position 0.0100 0.0075 0.0160) "Silicon" "R.Channel2")
(sdegeo:create-cuboid (position 0.0100 -0.0075 0.0120) (position 0.0250 0.0075 0.0160) "Silicon" "R.Drain2")
;--- Nanosheet Layer 3 ---
(sdegeo:create-cuboid (position -0.0150 -0.0075 0.0240) (position 0.0000 0.0075 0.0280) "Silicon" "R.Source3")
(sdegeo:create-cuboid (position 0.0000 -0.0075 0.0240) (position 0.0100 0.0075 0.0280) "Silicon" "R.Channel3")
(sdegeo:create-cuboid (position 0.0100 -0.0075 0.0240) (position 0.0250 0.0075 0.0280) "Silicon" "R.Drain3")

;--- Outer Metal Gate Block ---
(sdegeo:create-cuboid (position 0.0000 -0.0115 -0.0040) (position 0.0100 0.0115 0.0320) "Metal" "R.Gate")

;--- Oxide & Channel Core 1 ---
(sdegeo:create-cuboid (position 0.0000 -0.0085 -0.0010) (position 0.0100 0.0085 0.0050) "HfO2" "R.Oxide1")
(sdegeo:create-cuboid (position 0.0000 -0.0075 0.0000) (position 0.0100 0.0075 0.0040) "Silicon" "R.Channel1_Core")
;--- Oxide & Channel Core 2 ---
(sdegeo:create-cuboid (position 0.0000 -0.0085 0.0110) (position 0.0100 0.0085 0.0170) "HfO2" "R.Oxide2")
(sdegeo:create-cuboid (position 0.0000 -0.0075 0.0120) (position 0.0100 0.0075 0.0160) "Silicon" "R.Channel2_Core")
;--- Oxide & Channel Core 3 ---
(sdegeo:create-cuboid (position 0.0000 -0.0085 0.0230) (position 0.0100 0.0085 0.0290) "HfO2" "R.Oxide3")
(sdegeo:create-cuboid (position 0.0000 -0.0075 0.0240) (position 0.0100 0.0075 0.0280) "Silicon" "R.Channel3_Core")
...
(sdegeo:set-contact (find-face-id (position 0.0250 0.0 0.0020)) "drain")
(sdegeo:set-contact (find-face-id (position 0.0250 0.0 0.0140)) "drain")
(sdegeo:set-contact (find-face-id (position 0.0250 0.0 0.0260)) "drain")
(sdegeo:set-current-contact-set "gate")
(sdegeo:set-contact (find-face-id (position 0.0050 0.0 0.0320)) "gate")
(sdegeo:set-current-contact-set "substrate")
(sdegeo:set-contact (find-face-id (position 0.0050 0.0 -0.0340)) "substrate")
...
(sdedr:define-refeval-window "RefWin.Global" "Cuboid"
    (position -0.0150 -0.0115 -0.0340) (position 0.0250 0.0115 0.0320))
...
(sdedr:define-refeval-window "RefWin.SubBDI" "Cuboid"
    (position -0.0150 -0.0115 -0.0340) (position 0.0250 0.0115 -0.0040))
...
(sde:build-mesh "snmesh" "" "G_L10_W15_T04")
