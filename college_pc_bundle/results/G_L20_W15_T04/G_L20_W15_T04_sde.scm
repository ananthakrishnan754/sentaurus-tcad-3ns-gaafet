; Run: G_L20_W15_T04 (Lg=20nm, Wns=15.0nm, Tns=4.0nm, N=3)
(sde:clear)
(sdegeo:set-default-boolean "ABA")

;--- Substrate & BDI Base ---
(sdegeo:create-cuboid (position -0.0150 -0.0115 -0.0340) (position 0.0350 0.0115 -0.0140) "Silicon" "R.Substrate")
(sdegeo:create-cuboid (position -0.0150 -0.0115 -0.0140) (position 0.0350 0.0115 -0.0040) "SiO2" "R.BDI")

;--- Gate Metal Shell ---
(sdegeo:create-cuboid (position 0.0000 -0.0115 -0.0040) (position 0.0200 0.0115 0.0320) "TiN" "R.GateMetal")

;--- Low-k Inner Spacers ---
(sdegeo:create-cuboid (position -0.0150 -0.0115 -0.0040) (position 0.0000 0.0115 0.0320) "Si3N4" "R.SpacerS")
(sdegeo:create-cuboid (position 0.0200 -0.0115 -0.0040) (position 0.0350 0.0115 0.0320) "Si3N4" "R.SpacerD")

;--- Nanosheet Stack 1 ---
(sdegeo:create-cuboid (position 0.0000 -0.0085 -0.0010) (position 0.0200 0.0085 0.0050) "HfO2" "R.Oxide1")
(sdegeo:create-cuboid (position 0.0000 -0.0075 0.0000) (position 0.0200 0.0075 0.0040) "Silicon" "R.Channel1")
(sdegeo:create-cuboid (position -0.0150 -0.0075 0.0000) (position 0.0000 0.0075 0.0040) "Silicon" "R.Source1")
(sdegeo:create-cuboid (position 0.0200 -0.0075 0.0000) (position 0.0350 0.0075 0.0040) "Silicon" "R.Drain1")

;--- Nanosheet Stack 2 ---
(sdegeo:create-cuboid (position 0.0000 -0.0085 0.0110) (position 0.0200 0.0085 0.0170) "HfO2" "R.Oxide2")
(sdegeo:create-cuboid (position 0.0000 -0.0075 0.0120) (position 0.0200 0.0075 0.0160) "Silicon" "R.Channel2")
(sdegeo:create-cuboid (position -0.0150 -0.0075 0.0120) (position 0.0000 0.0075 0.0160) "Silicon" "R.Source2")
(sdegeo:create-cuboid (position 0.0200 -0.0075 0.0120) (position 0.0350 0.0075 0.0160) "Silicon" "R.Drain2")

;--- Nanosheet Stack 3 ---
(sdegeo:create-cuboid (position 0.0000 -0.0085 0.0230) (position 0.0200 0.0085 0.0290) "HfO2" "R.Oxide3")
(sdegeo:create-cuboid (position 0.0000 -0.0075 0.0240) (position 0.0200 0.0075 0.0280) "Silicon" "R.Channel3")
(sdegeo:create-cuboid (position -0.0150 -0.0075 0.0240) (position 0.0000 0.0075 0.0280) "Silicon" "R.Source3")
(sdegeo:create-cuboid (position 0.0200 -0.0075 0.0240) (position 0.0350 0.0075 0.0280) "Silicon" "R.Drain3")
...
(sdegeo:set-current-contact-surface (find-face-id (position 0.0350 0.0000 0.0000)))
(sdegeo:set-contact-name "drain")
(sdegeo:set-current-contact-surface (find-face-id (position 0.0100 -0.0115 0.0140)))
...
(sdedr:define-refinement-size "Ref.Channel" 0.0025 0.0019 0.0010 0.0013 0.0009 0.0005)
...
;--- Build Mesh ---
(sde:build-mesh "snmesh" " " "G_L20_W15_T04_msh")
(sde:save-model "G_L20_W15_T04_bnd")
(exit)